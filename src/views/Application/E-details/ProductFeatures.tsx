...
import { Card, CardBody, Col, Nav, Row, Tab, Table } from "react-bootstrap";
                            ...
                            <Tab.Pane eventKey="Overview" id="ecomtab-3" role="tabpanel" aria-labelledby="ecomtab-tab-3">
                                <div className="table-responsive">
                                    <p className="text-muted">
                                        ...
                                        <strong className="text-body">“When an unknown printer took a galley of type and scrambled it to make a type specimen book.”</strong>
