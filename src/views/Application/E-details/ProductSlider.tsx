                ...
                <div className="sticky-md-top product-sticky">
                    <div id="carouselExampleCaptions" className="carousel slide ecomm-prod-slider" data-bs-ride="carousel">
                        ...
                        <Swiper
                            ...
                            className="mySwiper2">
                            <SwiperSlide>
                                <Image src={product1} className="d-block rounded-3 img-fluid" alt="Product images" />
                            </SwiperSlide>
                            <SwiperSlide>
                                <Image src={product2} className="d-block rounded-3 img-fluid" alt="Product images" />
                            </SwiperSlide>
                            <SwiperSlide>
                                <Image src={product3} className="d-block rounded-3 img-fluid" alt="Product images" />
                            </SwiperSlide>
                            <SwiperSlide>
                                <Image src={product4} className="d-block rounded-3 img-fluid" alt="Product images" />
                            </SwiperSlide>
                            <SwiperSlide>
                                <Image src={product5} className="d-block rounded-3 img-fluid" alt="Product images" />
                            </SwiperSlide>
                            <SwiperSlide>
                                <Image src={product6} className="d-block rounded-3 img-fluid" alt="Product images" />
                            </SwiperSlide>
                            <SwiperSlide>
                                <Image src={product7} className="d-block rounded-3 img-fluid" alt="Product images" />
                            </SwiperSlide>
                            <SwiperSlide>
                                <Image src={product8} className="d-block rounded-3 img-fluid" alt="Product images" />
                            </SwiperSlide>
                        </Swiper>
