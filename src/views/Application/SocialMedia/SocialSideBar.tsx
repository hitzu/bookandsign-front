                        ...
                        <Row className="g-2">
                            <Col xs={4}>
                                <Link href="#" className="img-post card" data-lightbox={socgal1.src}>
                                    <Image src={socgal1} alt="img" className="card-img" height={97.83} />
                            ...
                            <Col xs={4}>
                                <Link href="#" className="img-post card" data-lightbox={socgal2.src}>
                                    <Image src={socgal2} alt="img" className="card-img" height={97.83} />
                                    <div className="card-img-overlay">
                                        <i className="ti ti-search"></i>
                                    </div>
                                </Link>
                            ...
                            <Col xs={4}>
                                <Link href="#" className="img-post card" data-lightbox={socgal3.src}>
                                    <Image src={socgal3} alt="img" className="card-img" height={97.83} />
                                    <div className="card-img-overlay">
                                        <i className="ti ti-search"></i>
                                    </div>
                                </Link>
                            ...
                            <Col xs={4}>
                                <Link href="#" className="img-post card" data-lightbox={socgal4.src}>
                                    <Image src={socgal4} alt="img" className="card-img" height={97.83} />
                                    <div className="card-img-overlay">
                                        <i className="ti ti-search"></i>
                                    </div>
                                </Link>
                            ...
                            <Col xs={4}>
                                <Link href="#" className="img-post card" data-lightbox={socgal5.src}>
                                    <Image src={socgal5} alt="img" className="card-img" height={97.83} />
                                    <div className="card-img-overlay">
                                        <i className="ti ti-search"></i>
                                    </div>
                                </Link>
                            ...
                            <Col xs={4}>
                                <Link href="#" className="img-post card" data-lightbox={socgal6.src}>
                                    <Image src={socgal6} alt="img" className="card-img" height={97.83} />
                                    <div className="card-img-overlay">
                                        <i className="ti ti-search"></i>
                                    </div>
                                </Link>
                            ...
                            <Col xs={4}>
                                <Link href="#" className="img-post card" data-lightbox={socgal7.src}>
                                    <Image src={socgal7} alt="img" className="card-img" height={97.83} />
                                    <div className="card-img-overlay">
                                        <i className="ti ti-search"></i>
                                    </div>
                                </Link>
                            ...
                            <Col xs={4}>
                                <Link href="#" className="img-post card" data-lightbox={socgal8.src}>
                                    <Image src={socgal8} alt="img" className="card-img" height={97.83} />
                                    <div className="card-img-overlay">
                                        <i className="ti ti-search"></i>
                                    </div>
                                </Link>
                            ...
                            <Col xs={4}>
                                <Link href="#" className="img-post card" data-lightbox={socgal9.src}>
                                    <Image src={socgal9} alt="img" className="card-img" height={97.83} />
                                    <div className="card-img-overlay">
                                        <i className="ti ti-search"></i>
                                    </div>
                                </Link>
