          ...
          <Row className="justify-content-center text-center">
            ...
            <Col md={12}>
              <div className="row justify-content-center client-block g-lg-4 g-3">
                <div className="col-auto wow animate__fadeInRight" data-wow-delay="0.3s"><Image src={eagames} alt="img" className="img-fluid" /></div>
                <div className="col-auto wow animate__fadeInRight" data-wow-delay="0.4s"><Image src={haswent} alt="img" className="img-fluid" /></div>
                <div className="col-auto wow animate__fadeInRight" data-wow-delay="0.5s"><Image src={crystal} alt="img" className="img-fluid" /></div>
                <div className="col-auto wow animate__fadeInRight" data-wow-delay="0.6s"><Image src={vodafone} alt="img" className="img-fluid" /></div>
                <div className="col-auto wow animate__fadeInRight" data-wow-delay="0.7s"><Image src={eagames} alt="img" className="img-fluid" /></div>
              </div>
            </Col>
          </Row>
        </div>
