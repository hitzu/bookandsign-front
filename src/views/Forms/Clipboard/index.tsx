...
const CopyToClipboard = CopyToClipboardOriginal as ComponentType<any>;
...
const Clipboard = () => {
  ...
  const [copyText1, setCopyText1] = useState<string>(
    ...
    <React.Fragment>
      <Row className="form-group">
        ...
        <Col lg={6} md={9} sm={12}>
          ...
          <small>
            You can do by adding a <code>data-clipboard-target</code> attribute
            in your trigger element
          </small>
        </Col>
      </Row>
      <Row className="mt-3">
        ...
        <Col lg={6} md={9} sm={12}>
          ...
          ></Form.Control>
          <small>
            you can define a <code>data-clipboard-action</code> attribute to
            specify if you want to either <code>copy</code> or
      ...
      <Row className="mt-3 mb-3">
        ...
        <Col lg={6} md={9} sm={12}>
          ...
          <div className="mt-2">
            <small>
              You can just include a <code>data-clipboard-text</code> attribute
              in your trigger element
            </small>
          </div>
        </Col>
      ...
      <Row className="form-group mb-0">
        ...
        <Col lg={6} md={9} sm={12}>
          <div
            id="pc-clipboard-4"
            style={{
              border: "4px solid rgba(234, 234, 234, 0.5)",
              padding: "10px",
            }}
          >
            Lorem ipsum cacilds, vidis litro abertis. Consetis adipiscings
