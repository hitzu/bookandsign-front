          ...
          <div className="container">
            <div className="row">
              ...
              >
                ...
                <p className="mb-4">
                  Since 2017, More than 50K+ Developers trust the Phoenixcoded
                  Digital Product. Mantis React is Manage under their
              ...
              <div className="col-md-8">
                <div className="row">
                  <div
                    className="col-sm-4 my-3 my-sm-0 wow animate__fadeInUp"
                    data-wow-delay="0.6s"
                  >
