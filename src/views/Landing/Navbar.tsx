      ...
      >
        <Container>
          <Link href="/dashboard" className="pc-navbar-brand">
            {themeMode === "dark" ? (
              <Image src={logoLight} alt="logo" className="logo-lg" priority />
            ) : (
              <Image src={logoDark} alt="logo" className="logo-lg" priority />
            )}
          </Link>
          <Navbar.Toggle
          ...
          >
            ...
            >
              ...
              <Nav.Item as="li" className="px-1">
                <Nav.Link href="https://light-able-react-components.vercel.app/">
                  Components
                </Nav.Link>
              </Nav.Item>
              <Nav.Item as="li" className="px-1">
            ...
            <Nav as="ul" className="mb-2 mb-lg-0 align-items-start">
              <NavDropdown
                bsPrefix="btn btn-icon btn-outline-dark border me-3 border-secondary border-opacity-25 dropdown-toggle arrow-none me-0 rounded"
                title={<i className="ph-duotone ph-sun-dim text-warning"></i>}
                id="basic-nav-dropdown"
              >
                <NavDropdown.Item
                  onClick={() => dispatch(changeThemeMode("dark"))}
                >
                  <i className="ph-duotone ph-moon"></i>
                  Dark
                </NavDropdown.Item>
                <NavDropdown.Item
                  onClick={() => dispatch(changeThemeMode("light"))}
                >
