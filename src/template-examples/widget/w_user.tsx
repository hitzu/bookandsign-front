                    ...
                    <Card className="user-card">
                        <Card.Body>
                            <div className="user-cover-bg">
                                <Image src={userCover} alt="image" className="img-fluid" priority />
                            ...
                            <div className="chat-avtar card-user-image">
                                <Image src={avatar1} alt="user-image" className="img-thumbnail rounded-circle " priority />
                    ...
                    <Card>
                        <Card.Body>
                            ...
                            <div className="border rounded p-3 my-3">
                                <div className="d-flex align-items-center">
                                    <div className="flex-shrink-0">
                                        <Image src={avatar1} alt="user-image" className="avtar rounded-circle wid-45 hei-45" priority />
                                    </div>
