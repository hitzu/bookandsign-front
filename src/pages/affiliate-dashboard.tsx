        ...
        {(affiliateWidget || []).map((item, key) => (
          <Col md={12} xxl={4} key={key}>
            <Card className="statistics-card-1">
              <Card.Body>
                <Image src={item.cardImg} alt="img" className="img-fluid img-bg" fetchPriority="high" priority={true}/>
                  ...
                  <tbody>
                    ...
                    {(affiliateData || []).map((item, key) => (
                      <tr key={key}>
                        <td>
                          <div className="d-flex align-items-center">
                            <Image src={item.img} alt="" className="img-fluid wid-30 rounded-1" style={{width:"30px",height:"30px"}} fetchPriority="high" priority={true}/>
