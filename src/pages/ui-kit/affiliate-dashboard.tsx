...
const AffiliateDashboard = () => {
    return (
       <>
       <BreadcrumbItem mainTitle="Ui kit" subTitle="Affiliate Dashboard"  />
       <Row>
            ...
            <Card className="statistics-card-1">
                ...
                <div className="d-flex align-items-center">
                    ...
                    <div className="d-flex align-items-end">
                        <h2 className="mb-0 f-w-500"><span className="text-muted">{item.suffix && item.suffix}</span> 
                        {item.price}
                         <small className="text-muted">{item.prefix && item.prefix}</small></h2>
